      ...
      */}
      <div>
                        ...
                        <a
                          ...
                          className={classNames(
                            item.current
                              ...
                              : 'text-[#d3de24] hover:bg-gray-50 hover:text-gray-900',
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
          ...
          <div className="flex flex-grow flex-col overflow-y-auto border-r border-gray-200 bg-gray-900 ">
            <div className="flex flex-shrink-0 items-center px-4">
              ...
              <div className="flex flex-1">
                <form className="flex w-full md:ml-0" action="#" method="GET">
                  ...
                  <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      id="search-field"
                      className="block h-full bg-gray-900 w-full border-transparent py-2 pl-8 pr-3 text-gray-900 placeholder-gray-500 focus:border-transparent focus:placeholder-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
                      placeholder="Search"
                      type="search"
                      name="search"
                    />
