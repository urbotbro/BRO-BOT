      ...
      */}
      <div>
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 ">
          ...
          <div className="flex flex-grow flex-col  border-r border-gray-200 bg-gray-900 ">
              ...
              <nav className="flex-1 space-y-1 px-2 pb-4">
                {navigation.map((item) => (
                  <a
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-gray-100 text-[#d3de24]' : 'text-gray-100 hover:bg-gray-50 hover:text-gray-900',
          ...
          <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-gray-900 shadow">
            ...
            <div className="flex flex-1 justify-between px-4">
              <div className="flex flex-1">
                <form className="flex w-full md:ml-0" action="#" method="GET">  
                  ...
                  <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                    ...
                    <input
                      id="search-field"
                      className="block h-full w-full border-transparent bg-gray-900 py-2 pl-8 pr-3 text-gray-900 placeholder-gray-500 focus:border-transparent focus:placeholder-gray-400 focus:outline-none focus:ring-0 sm:text-sm"
                      placeholder="Search"
                      type="search"
                      name="search"
                    />
              ...
              <div className="ml-4 flex items-center md:ml-6">
                <button
                  type="button"
                  className="rounded-full bg- p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
