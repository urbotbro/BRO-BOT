...
const Header = () => {
  return (
    <Flex as='header' justifyContent='center' align='center' background='#14191e' color='white' position='fixed' left='0' right='0' zIndex='1000'>
      <Flex as='div' position='sticky' maxWidth='1280px' width="100%" justify='space-between' align='center' paddingTop='10px' paddingBottom='10px'>
        ...
        <Box>
          <Link href="https://bro-dashboard-gules.vercel.app/">
            <Button borderRadius='100px' fontSize='14px' background='#cdf6f8'>
              Dashboard
            </Button>
          </Link>
        </Box>
