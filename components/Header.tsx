    ...
    <Flex as='header' justifyContent='space-between' align='center' color='white' position='fixed' top='0' width="100%" zIndex='1000' pl='5px' pr='5px'>
      <Flex as='div' position='sticky' maxWidth='2280px' width="100%" justify='space-between' align='center' paddingTop='10px' paddingBottom='10px' pl='5px' pr='5px'>
        ...
        <Box display={{ base: 'none', md: 'flex' }} justifyContent='space-between' alignItems='center'>
          ...
          <Link href='../public/BRO Bot Whitepaper.pdf' pl='10px' pr='10px' fontSize='15px' style={orbitronFont.style} _hover={{ color: '#9bf0f5' }} target="_blank">Whitepaper</Link>
        </Box>
      ...
      <Box position='fixed' zIndex={state ? 10000 : 0} background="#0c0f12" top='0' bottom='0' left='0' right='0' display={{ base: 'flex', md: 'none' }} visibility={state ? 'visible' : 'hidden'} justifyContent='center' alignItems='flex-end' flexDirection='column'>
        ...
        <Link mt='50px' mr='30px' opacity={state ? 1 : 0} onClick={() => { changeState(false) }} href='https://bro-bot-academy.gitbook.io/brobot' pl='10px' pr='10px' fontSize='20px' style={orbitronFont.style} _hover={{ color: '#9bf0f5' }}>Docs</Link>
        <Link mt='50px' mr='30px' opacity={state ? 1 : 0} onClick={() => { changeState(false) }} href='../public/BRO Bot Whitepaper.pdf' pl='10px' pr='10px' fontSize='20px' style={orbitronFont.style} _hover={{ color: '#9bf0f5' }}>Whitepaper</Link>
        ...
        <Box as='div' visibility={smallTool ? 'visible' : 'hidden'} zIndex={smallTool ? 1000 : 0} opacity={smallTool ? 1 : 0} transition={'all .2s ease-in-out'} flexDirection='column' width='80%' background="#161c21" padding='10px' borderRadius='5px' right='10px' transform='translateY(286px)' position='absolute'>
          <ChakraLink onClick={() => { toggleSmallTool(false) }} as={Link} href='#' pt='10px' pb='10px' pl='5px' pr='5px' _hover={{ textDecoration: 'none', background: '#1e262d' }} display='flex' alignItems='center'><Box className={glitch.menu} width='25px' height='25px'><FaTelegram /></Box> <Box as='span' ml='10px'>BRO SNIPER BOT</Box></ChakraLink>
          <Divider opacity='.1' />
